...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                .setName('group')
                .setDescription(
                    'the name of the group to create a reaction message for'
                )
                .setRequired(true)
        )
        ...
        .addStringOption((option) =>
            option
                .setName('message')
                .setDescription(
                    'an optional message to put along with your reaction role message'
                )
        ),
    ...
    async execute(interaction) {
        ...
        for (const role of roles) {
            const discordRole = await interaction.guild.roles.fetch(
                role.roleId
            );
