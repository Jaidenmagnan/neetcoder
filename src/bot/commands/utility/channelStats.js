...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription("get the stats of the top 5 channels, this feature is WIP")
  ...
  async execute(interaction) {
	  ...
	  topFive.forEach(channel => {
		  data[interaction.guild.channels.cache.get(channel.channel_id).name] = channel.message_count;
	  })
